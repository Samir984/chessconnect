...
//   console.log(session);
  return (
    <button
      className="flex items-center gap-2  bg-gray-800 text-white rounded-lg shadow-md hover:bg-gray-700 transition-all duration-300 w-full"
      onClick={() => {
    ...
    >
      <GoogleButtonIcon />
      <span className="  font-sm"> Google Sign in</span>
    </button>
  );
}
